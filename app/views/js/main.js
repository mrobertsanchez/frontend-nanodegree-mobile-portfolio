...
function updatePositions() {
  ...
  var scrollNumber = (document.documentElement.scrollTop/1250);
  var locationNumbers = [
    Math.sin(scrollNumber + 0),
    Math.sin(scrollNumber + 1),
    Math.sin(scrollNumber + 2),
    Math.sin(scrollNumber + 3),
    Math.sin(scrollNumber + 4)
  ]
  for (var i = 0; i < items.length; i++) {
    var phase = locationNumbers[i%5];
