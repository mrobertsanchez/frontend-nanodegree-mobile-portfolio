...
var resizePizzas = function(size) {
  ...
  // removed repeated document.querySelectorAll(".randomPizzaContainer") and applied it to var checkPizzaSizes
  function changePizzaSizes(size) {
    ...
    var checkPizzaSizes = document.querySelectorAll(".randomPizzaContainer");
    //var dx = determineDx(checkPizzaSizes[i], size);
    //var newwidth = (checkPizzaSizes[i].offsetWidth + dx) + 'px';
    for (var i = 0; i < checkPizzaSizes.length; i++) {
      checkPizzaSizes[i].style.width = newWidth+"%";
    }
  }
...
function updatePositions() {
  ...
  var bodyNumber = (document.documentElement.scrollTop/1250);
  var phaseNumbers = [
    Math.sin(bodyNumber + 0),
    Math.sin(bodyNumber + 1),
    Math.sin(bodyNumber + 2),
    Math.sin(bodyNumber + 3),
    Math.sin(bodyNumber + 4)
  ]
